...
public class Confirmation_choix_facebook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_confirmation_choix_facebook );
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == MY_REQUEST_CODE){
            ...
            if(resultCode == RESULT_OK){
                ...
                progressDialog.setMessage("La Kafèt traite vos données facebook, patientez...");
                ...
                final String nom = current_user.getDisplayName().toString().trim();
                final String email = current_user.getEmail().toString().trim();
                final String image = current_user.getPhotoUrl().toString().trim();
                ...
                mDatabase.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Confirmation_choix_facebook.this, "Enregistrement réussi pour " + nom , Toast.LENGTH_SHORT).show();
                            progressDialog.hide();
                            startActivity( new Intent( Confirmation_choix_facebook.this, ActivityBDE.class ) );
    ...
    //---------------------------------------------------------PROCEDURE POUR RECUPERER LA CLE SECRETE-------------------------------------------------------
    private void printKeyHash() {

        try{
            PackageInfo info = getPackageManager().getPackageInfo( "esirem.com.lakaftnumrique", PackageManager.GET_SIGNATURES);
