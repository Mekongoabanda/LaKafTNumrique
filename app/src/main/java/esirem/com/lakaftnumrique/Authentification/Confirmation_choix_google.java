...
public class Confirmation_choix_google extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_confirmation_choix_google);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == MY_REQUEST_CODE){
            ...
            if(resultCode == RESULT_OK){
                ...
                mDatabase.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Confirmation_choix_google.this, "Enregistrement réussi pour " + nom , Toast.LENGTH_SHORT).show();
                            progressDialog.hide();
                            Intent Info = new Intent (Confirmation_choix_google.this, ActivityInfo.class );
                            startActivity( Info );
                ...
                Toast.makeText( Confirmation_choix_google.this, "" + response.getError().getMessage(), Toast.LENGTH_SHORT ).show();
            }
        }
    }
